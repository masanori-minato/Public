"""
===============================================================================
 CSVファイル一括Parquet変換プログラム
===============================================================================

指定フォルダー内のCSVファイルを読み込み、ファイルごとにParquet形式へ
変換します。日本語Windowsで使われる代表的な文字コードを順番に試すため、
UTF-8やShift_JIS（CP932）のCSVをまとめて処理できます。

デフォルトの入出力先:
    入力: ~/Downloads/CSV
    出力: ~/Downloads/CSV/parquet_out
...
実行例:
    ...
    python convert_csv_to_parquet.py --all-string --overwrite
    python convert_csv_to_parquet.py -i "C:\\input" -o "C:\\output"
